 ...
 * where an uncaught throwable reaches the process default handler (crash on JVM/Android, abort on
 * Kotlin/Native) — a `SupervisorJob` stops sibling cancellation, it is NOT a handler.
 */
