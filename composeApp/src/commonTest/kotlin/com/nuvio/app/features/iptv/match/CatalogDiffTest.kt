...
class CatalogDiffTest {
    ...
    @Test
    fun unchangedCatalogProducesEmptyDiff() {
    ...
    @Test
    fun newItemIsUpsertedWithoutTouchingExisting() {
    ...
    @Test
    fun renamedItemIsUpsertedAndFlaggedForOldKeyDeletion() {
    ...
    @Test
    fun lateTmdbBackfillCountsAsChange() {
    ...
    @Test
    fun vanishedItemLandsInGoneSids() {
    ...
    @Test
    fun duplicateFetchedSidDoesNotDoubleReport() {
